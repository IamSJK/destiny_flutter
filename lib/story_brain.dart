...
class StoryBrain {
  ...
  void nextStory(int checkNumber) {
    if (checkNumber == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (checkNumber == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (checkNumber == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (checkNumber == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (checkNumber == 2 && _storyNumber == 2) {
      _storyNumber = 4;
    } else if (checkNumber == 1 && _storyNumber == 2) {
      _storyNumber = 3;
